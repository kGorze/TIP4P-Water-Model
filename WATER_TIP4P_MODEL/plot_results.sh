...
echo "Summary report is available at ${PLOTS_DIR}/tip4p_water_analysis_summary.png"
echo "Text summary is available at ${PLOTS_DIR}/tip4p_water_analysis_summary.txt" 