...
if [ $? -eq 0 ]; then
    ...
    log "Summary report is available at ${PLOTS_DIR}/tip4p_water_analysis_summary.png"
    log "Text summary is available at ${PLOTS_DIR}/tip4p_water_analysis_summary.txt"
else
